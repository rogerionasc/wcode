        ...
        <header class="navbar navbar-expand-md d-print-none" >
            <div class="container-xl">
                ...
                <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
                    <a href=".">
                        <img src="../../img/Logo250x250.svg" width="250px" alt="Tabler" class="navbar-brand-image">
                        <img src="../../img/LogoName210x500.svg" width="500px" alt="Tabler" class="navbar-brand-image navbar-brand-name">
                    </a>
                </h1>
